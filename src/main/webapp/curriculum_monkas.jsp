...
<div class="text">
    ...
    <p>MonkaS is a Better Twitch TV emote featuring an illustration of Pepe the Frog
        ...
        moments of high tension in video game matches to express anxiety.</p>
    <br>
    <h2>Origin:</h2>
    <p>The earliest known archived 4chan thread in which the sweating, nervous Pepe the Frog
        illustration appeared was submitted to the /lit/ (literature) board on July 16th, 2011.
    ...
    <p>On February 17th, 2017, Redditor kucykzaglady submitted a picture of the emote
        ...
        On April 1st, Twitter user @nanilul attempted to place a monkaS emote on
